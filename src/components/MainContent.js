        ...
        <div className="col-md-8">
                ...
                <div className="box-body">
                  ...
                  <div className="direct-chat-messages">
                    ...
                    <div className="direct-chat-msg">
                      ...
                      <img className="direct-chat-img" src="dist/img/user1-128x128.jpg" alt="message user" />{/* /.direct-chat-img */}
                    ...
                    <div className="direct-chat-msg right">
                      ...
                      <img className="direct-chat-img" src="dist/img/user3-128x128.jpg" alt="message user" />{/* /.direct-chat-img */}
                      <div className="direct-chat-text">
                  ...
                  <div className="direct-chat-contacts">
                    <ul className="contacts-list">
                      <li>
                        <a href="fake_url">
                          <img className="contacts-list-img" src="dist/img/user1-128x128.jpg" alt="message user" />
                      ...
                      <li>
                        <a href="fake_url">
                          <img className="contacts-list-img" src="dist/img/user7-128x128.jpg" alt="message user" />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Sarah Doe
                      ...
                      <li>
                        <a href="fake_url">
                          <img className="contacts-list-img" src="dist/img/user3-128x128.jpg" alt="message user" />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Nadia Jolie
                      ...
                      <li>
                        <a href="fake_url">
                          <img className="contacts-list-img" src="dist/img/user5-128x128.jpg" alt="message user" />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Nora S. Vans
                      ...
                      <li>
                        <a href="fake_url">
                          <img className="contacts-list-img" src="dist/img/user6-128x128.jpg" alt="message user" />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              John K.
                      ...
                      <li>
                        <a href="fake_url">
                          <img className="contacts-list-img" src="dist/img/user8-128x128.jpg" alt="message user" />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Kenneth M.
            ...
            <div className="col-md-6">
              ...
              <div className="box box-danger">
                ...
                <div className="box-footer text-center">
                  <a href="fake_url" className="uppercase">View All Users</a>
                </div>{/* /.box-footer */}
              </div>{/*/.box */}
            </div>{/* /.col */}
          </div>{/* /.row */}
          ...
          <div className="box box-info">
            ...
            <div className="box-footer clearfix">
              <a href="fake_url" className="btn btn-sm btn-info btn-flat pull-left">Place New Order</a>
              <a href="fake_url" className="btn btn-sm btn-default btn-flat pull-right">View All Orders</a>
            </div>{/* /.box-footer */}
          </div>{/* /.box */}
        </div>{/* /.col */}
        <div className="col-md-4">
          ...
          <div className="box box-default">
            ...
            <div className="box-footer no-padding">
              <ul className="nav nav-pills nav-stacked">
                <li><a href="fake_url">United States of America <span className="pull-right text-red"><i className="fa fa-angle-down" /> 12%</span></a></li>
                <li><a href="fake_url">India <span className="pull-right text-green"><i className="fa fa-angle-up" /> 4%</span></a></li>
                <li><a href="fake_url">China <span className="pull-right text-yellow"><i className="fa fa-angle-left" /> 0%</span></a></li>
              </ul>
            </div>{/* /.footer */}
          </div>{/* /.box */}
          {/* PRODUCT LIST */}
          <div className="box box-primary">
              ...
              <ul className="products-list product-list-in-box">
                <li className="item">
                  ...
                  <div className="product-info">
                    <a href="fake_url" className="product-title">Samsung TV <span className="label label-warning pull-right">$1800</span></a>
                ...
                <li className="item">
                  ...
                  <div className="product-info">
                    <a href="fake_url" className="product-title">Bicycle <span className="label label-info pull-right">$700</span></a>
                    <span className="product-description">
                ...
                <li className="item">
                  ...
                  <div className="product-info">
                    <a href="fake_url" className="product-title">Xbox One <span className="label label-danger pull-right">$350</span></a>
                    <span className="product-description">
                ...
                <li className="item">
                  ...
                  <div className="product-info">
                    <a href="fake_url" className="product-title">PlayStation 4 <span className="label label-success pull-right">$399</span></a>
                    <span className="product-description">
            ...
            <div className="box-footer text-center">
              <a href="fake_url" className="uppercase">View All Products</a>
            </div>{/* /.box-footer */}
          </div>{/* /.box */}
        </div>{/* /.col */}
      </div>{/* /.row */}

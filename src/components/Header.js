      ...
      <div className="navbar-custom-menu">
        <ul className="nav navbar-nav">
              ...
              <li>
                ...
                <ul className="menu">
                  ...
                  <li>
                    <a href="fake_url">
                      <div className="pull-left">
                        <img src="dist/img/faith_baba128x128.jpg" className="img-circle" alt="User" />
                      </div>
                      <h4>
                        Sales Department
          ...
          <li className="dropdown user user-menu">
            <a href="fake_url" className="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/faith_baba.jpg" className="user-image" alt="User" />
              <span className="hidden-xs">Faith Olusegun</span>
            </a>
            <ul className="dropdown-menu">
              {/* User image */}

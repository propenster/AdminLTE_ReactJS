    ...
    <section className="sidebar">
      ...
      <div className="user-panel">
        <div className="pull-left image">
          <img src="dist/img/faith_baba.jpg" className="img-circle" alt="User" />
        </div>
      ...
      <ul className="sidebar-menu">
        ...
        <li>
          <a href="pages/widgets.html">
            <i className="fa fa-th" /> <span>Widgets</span> <small className="label pull-right bg-green">new</small>
          </a>
        </li>
        <li className="treeview">
          <a href="fake_url">
        ...
        <li className="treeview">
          ...
          <ul className="treeview-menu">
            ...
            <li>
              <a href="fake_url"><i className="fa fa-circle-o" /> Level One <i className="fa fa-angle-left pull-right" /></a>
              <ul className="treeview-menu">
                <li><a href="fake_url"><i className="fa fa-circle-o" /> Level Two</a></li>
                <li>
                  <a href="fake_url"><i className="fa fa-circle-o" /> Level Two <i className="fa fa-angle-left pull-right" /></a>
                  <ul className="treeview-menu">
